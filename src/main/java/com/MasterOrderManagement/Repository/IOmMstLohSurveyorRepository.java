...
public interface IOmMstLohSurveyorRepository extends JpaRepository<OmMstLohSurveyor,String>{
	
	public Optional<OmMstLohSurveyor> findByOmlsLohId(String lohid);
